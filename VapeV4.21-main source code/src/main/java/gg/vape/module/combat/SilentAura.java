...
extends Mod {
    ...
    private final BooleanValue raycastCheck;
    private final BooleanValue lockTarget;
    ...
    public SilentAura() {
        ...
        this.attackRange = NumberValue.createWithDescription(this, "Attack range", "#.#", "", 0.0, 3.0, 6.0, "Base distance at which Aura engages and attacks (plus Extra swing distance)");
        this.raycastCheck = BooleanValue.create(this, "Raycast check", false, "Only attack while your crosshair is on the target");
        this.lockTarget = BooleanValue.create(this, "Lock target", false, "Keep attacking the current target until it dies or leaves range");
        ...
        this.addValue(this.targetFilter, this.aimSpeed, this.attackRate, this.attackRange, this.extraSwingDistance, this.maxAngle, this.targetMode, this.targetArea, this.lockTarget, this.raycastCheck);
    ...
    public boolean canAttack() {
        ...
        if (this.raycastCheck.getEffectiveValue().booleanValue() && !this.isLookingAtTarget()) {
            return false;
        }
    ...
    private void updateTarget() {
        ...
        if (this.lockTarget.getEffectiveValue().booleanValue() && this.target != null && this.isValidTarget(this.target)) {
    ...
    private double getAttackRange() {
        return (Double)this.attackRange.getValue() + (Double)this.extraSwingDistance.getValue();
    }
